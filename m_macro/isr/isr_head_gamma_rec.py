...
b_vars = b_vars + vu.create_aliases_for_selected(["mcISR"], "vpho:gen -> [vpho:list_rec -> p+ pi- ^gamma] anti-n0")
"""
...
sig_cuts = "vpho_mRecoil>0 and vpho_mRecoil <2 and vpho_p_mcPDG == 2212 and vpho_pi_mcPDG == -211" 
