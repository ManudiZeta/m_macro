...
ma.inputMdstList(filelist=["root_file/my_mdst_output.root"],path=main)
...
ma.variablesToNtuple("Upsilon(4S):list_rec",variables=b_vars,filename="root_file/vpho_p_pi_gamma.root",treename="tree",path=main,)
